...
var lpaddleYPos = Math.floor((fieldHeight - paddleHeight) / 2);  // middle
...
function Paddle2(width, height, color, speed, xpos, ypos) {
    this.width = width;
    this.height = height;
    this.speed = speed;
    this.obj = document.getElementById("lpaddle");
    this.obj.style.width = width.toString() + "px";
    this.obj.style.height = height.toString() + "px";
...
// instantiate a secone paddle
var lpaddle = new Paddle2(paddleWidth, paddleHeight, paddleColor, paddleSpeed, lpaddleXPos, lpaddleYPos);
output("paddle 2");
